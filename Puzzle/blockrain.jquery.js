...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      blockWidth: localStorage.getItem('width'), // How many blocks wide the field is (The standard is 10 blocks)
      ...
      speed: localStorage.getItem('speed'), // The speed of the game. The higher, the faster the pieces go.
    ...
    _setupControls: function(enable) {
      ...
      var handleKeyDown = function(evt) {
        ...
        caught = true;
        document.getElementById('w').addEventListener('click', function(){game._board.cur.rotate('right');})
        document.getElementById('a').addEventListener('click', function(){ moveLeft(true);})
        document.getElementById('s').addEventListener('click', function(){drop(true);})
        document.getElementById('d').addEventListener('click', function(){moveRight(true);})
