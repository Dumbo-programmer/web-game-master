...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      onStart: function(){},
      onRestart: function(){},
      onGameOver: function urmum(score){//score
...
let inc = parseInt(localStorage.getItem('credito'))
if(bb !== null){
firebase.firestore().collection('credits').doc(localStorage.getItem('ID')).set({
credits: inc+bb
}, {merge: true})
}else{
  firebase.firestore().collection('credits').doc(localStorage.getItem('ID')).set({
