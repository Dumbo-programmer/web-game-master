...
//                     " pot_remainder: " + pot_remainder);
  ...
  mynumberofroundswon++;
  var getmycurrenttime = new Date().toLocaleString();
  var winningstring =   "[" + getmycurrenttime + "] " + "<font color='blue'>Game</font>: " + mynumberofgames + ", <font color='blue'>You win this round and get 10 credits</font>: " + mynumberofroundswon + "/" + mynumberofrounds;
creditFb();
 // gui_log_to_history(winningstring);
  ...
  if (human_loses == 1) {
    ...
    if (num_playing < 2) {
      ...
      if (has_money(0)) {
        end_msg += "\n\nYOU WIN " + players[0].name.toUpperCase() + "+10 credits!!!";
            audio1.play();
            audio5.play();
            creditFb();
       document.getElementById("avatar1").src = "avatar/_bot1_normal.png"; 
